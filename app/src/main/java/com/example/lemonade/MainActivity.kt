...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when (lemonadeState) {
            ...
            SQUEEZE -> {
                // Check if lemon has been juiced
                if (lemonSize == 0) {
                    lemonadeState = DRINK
                    lemonSize = -1
                }
                // If lemon hasn't been juiced, update counts
                squeezeCount++
                lemonSize--
            }
    ...
    private fun showSnackbar(): Boolean {
        ...
        val squeezeText = getString(R.string.squeeze_count, squeezeCount, lemonadeState)
        Snackbar.make(
